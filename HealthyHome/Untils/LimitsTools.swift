...
class LimitsTools: NSObject {
    ...
    func showCameraAlert() {
        ...
        ComponentAlter.show(title: cameraLimitStr, msg: clickCameraStr, leftActionTitle: "取消", rightActionTitle: "设置", leftHandler: {
    ...
    func showLibraryAlert() {
        ...
        ComponentAlter.show(title: libraryLimitStr, msg: clickLibraryStr, leftActionTitle: "取消", rightActionTitle: "设置", leftHandler: {
