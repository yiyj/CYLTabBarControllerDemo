...
public class AlterlManager {
    public static let share = AlterlManager()
    var supportQuene: Bool = false
    var animationFromValue: CGFloat = 1
    public var successImage = UIImage(named: "ic_toast_success2")
    public var failImage = UIImage(named: "icn_icn_fail2")
    public var warnImage = UIImage(named: "icon_sign2")
    /// 内容的对齐方式
...
//        queue.maxConcurrentOperationCount = 1
    ...
    func common() {
        self.successImage = UIImage(named: "ic_toast_success2")
        self.failImage = UIImage(named: "icn_icn_fail2")
        self.warnImage = UIImage(named: "icon_sign2")
