...
typealias CustomViewClouse = (UIView?) -> ()

class AlterCustomView: UIView {
    ...
    open var leftHandler: CustomViewClouse?
    open var rightHandler: CustomViewClouse?
    ...
    override func layoutSubviews() {
        ...
        if self.leftActionTitle == nil || self.leftActionTitle?.count == 0 {
            ...
            self.rightBtn.setTitleColor(Config.share.mainColor, for: .normal)
            return
        }
