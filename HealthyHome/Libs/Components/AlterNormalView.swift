...
typealias normalViewLeftClouse = ()->()
typealias normalViewRightClouse = ()->()

class AlterNormalView: UIView {
    ...
    var timer: DispatchSourceTimer?
        ...
        open var leftHandler: normalViewLeftClouse?
        open var rightHandler: normalViewRightClouse?
